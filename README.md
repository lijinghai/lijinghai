...
&emsp;我的技术方向涵盖自动驾驶中的感知、定位与控制，熟练掌握ROS 2系统及基于Autoware平台的自动驾驶软件开发。熟悉4D激光雷达数据采集与处理，使用PointLIO算法实现高精度SLAM，具备先进的环境建图与定位能力。

&emsp;同时，我精通WEB全栈微服务开发、Python和C++编程，熟悉机器视觉技术（如YOLO目标识别）及深度学习模型在边缘计算中的应用。对于传感器融合、UWB定位等多源信息融合技术也有深入理解和实践。
